...
- (void)viewDidLoad {
    ...
    javaScriptCoreButton_UI.frame = CGRectMake(30.0,150.0, self.view.bounds.size.width - 30.0 * 2, 50.0);
    ...
    jsExportButton_UI.frame = CGRectMake(30.0, 200.0, self.view.bounds.size.width - 30.0 * 2, 50.0);
